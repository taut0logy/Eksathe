...
export default function AttachmentPreview({attachment}) {
    return (
        <div>
            <div className="w-full flex items-center gap-2 py-2 px-3 rounded-md bg-primary/30">
                {
                ...
                {!isPreviewable(attachment.file) && (
                    <div className="w-10 h-10 flex items-center justify-center bg-info text-gray-800 rounded">
